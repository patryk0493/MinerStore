...
if(empty($_GET['tak'])) {
if(empty($id)) {
echo "Nie wybrałeś usługi do usunięcia! <a class=\"link2 button\" href=\"services.php\">Powrót</a>";
}
else {
$dane = mysql_query("SELECT * FROM services WHERE id='$id'");
$r = mysql_fetch_assoc($dane);
echo "Czy na pewno chcesz usnąć usługę \"".$r['nazwa']."\" o id ".$id."?<br>";
echo "<a class=\"link2 button\" href=\"deleteservice.php?tak=1&id=".$id."\">Tak</a> <a class=\"link2 button\" href=\"deleteservice.php?tak=0\">Nie</a>";
}
}
else {
if($_GET['tak'] = 1){
	...
	echo "Pomyślnie usunięto usługę! <a class=\"link2 button\" href=\"services.php\">Powrót</a>";
}
elseif ($_GET['tak'] = 0) {
	echo "Anulowano. <a class=\"link2 button\" href=\"services.php\">Powrót</a>";
	}
else {
