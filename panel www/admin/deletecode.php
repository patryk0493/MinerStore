...
if(empty($_GET['tak'])) {
if(empty($id)){
echo "Nie wybrałeś kodu do usunięcia! <a class=\"link2 button\" href=\"codes.php\">Powrót</a>";
}
else {
$dane = mysql_query("SELECT * FROM codes WHERE id='$id'");
$r = mysql_fetch_assoc($dane);
echo "Czy na pewno chcesz usunąć kod o nazwie \"".$r['nazwa']."\" o id \"".$id."\"?<br>";
echo "<a class=\"link2 button\" href=\"deletecode.php?tak=1&id=".$id."\">Tak</a> <a class=\"link2 button\" href=\"deletecode.php?tak=0\">Nie</a>";
}
}
else {
if($_GET['tak'] = 1){
	...
	echo "Pomyślnie usunięto usługę! <a class=\"link2 button\" href=\"codes.php\">Powrót</a>";
}
elseif ($_GET['tak'] = 0) {
	echo "Anulowano. <a class=\"link2 button\" href=\"codes.php\">Powrót</a>";
	}
else {
